...
function MuscleHeatmap({ prs, allEx, bwLog, d }) {
  ...
  const silhouette = (
    <>
      {/* HEAD */}
      <ellipse cx="100" cy="25" rx="18" ry="21" {...bf}/>
      {/* TORSO + SHOULDERS (one continuous path, deltoid caps built in) */}
      <path d="M94,44 C89,48 83,54 76,62 C66,68 52,78 46,94 C40,110 41,127 48,137 C55,147 67,151 76,145 C75,158 73,173 71,188 C69,203 67,218 68,231 C70,244 76,254 87,258 L100,261 L113,258 C124,254 130,244 132,231 C133,218 131,203 129,188 C127,173 125,158 124,145 C133,151 145,147 152,137 C159,127 160,110 154,94 C148,78 134,68 124,62 C117,54 111,48 106,44 Z" {...bf}/>
      {/* LEFT ARM — upper arm + forearm + hand, one closed path overlapping shoulder */}
      <path d="M50,112 C44,126 41,143 41,160 C41,178 43,196 47,212 C49,224 51,235 51,244 C50,253 48,262 46,269 C44,275 44,280 47,284 C50,287 54,286 57,282 C60,278 61,270 62,260 C63,249 63,237 64,224 C65,209 67,192 68,174 C70,157 71,140 71,124 C67,114 59,110 51,112 Z" {...bf}/>
      {/* RIGHT ARM */}
      <path d="M150,112 C156,126 159,143 159,160 C159,178 157,196 153,212 C151,224 149,235 149,244 C150,253 152,262 154,269 C156,275 156,280 153,284 C150,287 146,286 143,282 C140,278 139,270 138,260 C137,249 137,237 136,224 C135,209 133,192 132,174 C130,157 129,140 129,124 C133,114 141,110 149,112 Z" {...bf}/>
      {/* LEFT LEG — thigh + knee + calf + foot */}
      <path d="M75,260 C71,280 70,304 72,327 C74,346 79,360 83,368 C85,378 86,392 85,408 C84,422 82,434 81,442 C73,445 64,448 62,452 L100,452 L100,260 Z" {...bf}/>
      {/* RIGHT LEG */}
      <path d="M125,260 C129,280 130,304 128,327 C126,346 121,360 117,368 C115,378 114,392 115,408 C116,422 118,434 119,442 C127,445 136,448 138,452 L100,452 L100,260 Z" {...bf}/>
      {/* inner thigh gap + knee caps */}
      <ellipse cx="88" cy="367" rx="13" ry="8" {...bf}/>
      <ellipse cx="112" cy="367" rx="13" ry="8" {...bf}/>
    </>
  );

  const svgStyle = { width:"100%", maxWidth:148, display:"block" };

  const frontSvg = (
    <svg viewBox="0 0 200 455" style={svgStyle}>
      {silhouette}
      {/* CHEST left pec */}
      <path d="M100,78 C85,74 68,75 59,85 C53,93 53,107 58,117 C63,127 74,132 85,132 C95,132 100,126 100,116 Z" {...mp("chest")}/>
      {/* CHEST right pec */}
      <path d="M100,78 C115,74 132,75 141,85 C147,93 147,107 142,117 C137,127 126,132 115,132 C105,132 100,126 100,116 Z" {...mp("chest")}/>
      <path d="M100,79 L100,119" {...WL}/>
      <path d="M61,104 C74,108 87,110 100,110 C113,110 126,108 139,104" {...WL}/>
      {/* SHOULDERS left anterior delt */}
      <path d="M47,94 C41,105 40,119 44,130 C48,140 57,144 66,140 C75,136 78,124 76,113 C73,101 64,93 54,94 Z" {...mp("shoulders")}/>
      {/* SHOULDERS right */}
      <path d="M153,94 C159,105 160,119 156,130 C152,140 143,144 134,140 C125,136 122,124 124,113 C127,101 136,93 146,94 Z" {...mp("shoulders")}/>
      <path d="M46,111 C54,115 63,117 76,114" {...WL}/>
      <path d="M154,111 C146,115 137,117 124,114" {...WL}/>
      {/* BICEPS left */}
      <path d="M42,120 C38,134 37,152 41,166 C44,177 51,182 58,179 C64,176 66,165 65,151 C64,137 59,123 53,119 C48,116 43,118 42,120 Z" {...mp("biceps")}/>
      {/* BICEPS right */}
      <path d="M158,120 C162,134 163,152 159,166 C156,177 149,182 142,179 C136,176 134,165 135,151 C136,137 141,123 147,119 C152,116 157,118 158,120 Z" {...mp("biceps")}/>
      <path d="M41,143 C49,145 57,145 66,143" {...WL}/>
      <path d="M159,143 C151,145 143,145 134,143" {...WL}/>
      {/* ABS 6-pack */}
      <rect x="88" y="134" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="102" y="134" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="88" y="150" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="102" y="150" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="88" y="166" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="102" y="166" width="10" height="12" rx="3" {...mp("abs")}/>
      {/* Obliques */}
      <path d="M58,130 C55,144 55,160 58,173 C61,183 67,189 73,190 L76,176 C73,165 72,153 73,141 C73,130 75,120 78,113 C71,113 64,118 58,130 Z" {...mp("abs")}/>
      <path d="M142,130 C145,144 145,160 142,173 C139,183 133,189 127,190 L124,176 C127,165 128,153 127,141 C127,130 125,120 122,113 C129,113 136,118 142,130 Z" {...mp("abs")}/>
      {/* QUADS left */}
      <path d="M75,262 C71,282 70,306 73,328 C75,345 80,358 87,364 L97,364 C101,357 103,342 103,321 C103,298 101,274 98,260 C95,249 87,246 80,248 Z" {...mp("quads")}/>
      {/* QUADS right */}
      <path d="M125,262 C129,282 130,306 127,328 C125,345 120,358 113,364 L103,364 C99,357 97,342 97,321 C97,298 99,274 102,260 C105,249 113,246 120,248 Z" {...mp("quads")}/>
      <path d="M83,265 C83,290 83,315 82,347" {...WL}/>
      <path d="M91,263 C91,288 91,315 91,348" {...WL}/>
      <path d="M109,263 C109,288 109,315 109,348" {...WL}/>
      <path d="M117,265 C117,290 117,315 118,347" {...WL}/>
      {/* CALVES left */}
      <path d="M71,376 C67,394 67,415 71,433 C74,447 80,454 86,455 L93,455 C97,451 100,440 101,424 C102,405 100,384 97,374 Z" {...mp("calves")}/>
      {/* CALVES right */}
      <path d="M129,376 C133,394 133,415 129,433 C126,447 120,454 114,455 L107,455 C103,451 100,440 99,424 C98,405 100,384 103,374 Z" {...mp("calves")}/>
      <path d="M80,378 C80,402 80,428 80,450" {...WL}/>
      <path d="M87,376 C87,400 87,426 87,451" {...WL}/>
      <path d="M113,376 C113,400 113,426 113,451" {...WL}/>
      <path d="M120,378 C120,402 120,428 120,450" {...WL}/>
    </svg>
  );
  ...
  const backSvg = (
    <svg viewBox="0 0 200 455" style={svgStyle}>
      {silhouette}
      {/* TRAPS */}
      <path d="M93,52 C80,58 67,69 64,80 C61,90 63,100 72,106 C82,111 92,112 100,111 C108,112 118,111 128,106 C137,100 139,90 136,80 C133,69 120,58 107,52 Z" {...mp("traps")}/>
      <path d="M100,53 L100,109" {...WL}/>
      <path d="M76,72 C84,76 92,78 100,78 C108,78 116,76 124,72" {...WL}/>
      {/* REAR DELTS left */}
      <path d="M47,94 C41,105 40,119 44,130 C48,140 57,144 66,140 C75,136 78,124 76,113 C73,101 64,93 54,94 Z" {...mp("reardelts")}/>
      {/* REAR DELTS right */}
      <path d="M153,94 C159,105 160,119 156,130 C152,140 143,144 134,140 C125,136 122,124 124,113 C127,101 136,93 146,94 Z" {...mp("reardelts")}/>
      {/* TRICEPS left */}
      <path d="M42,120 C38,134 37,152 41,166 C44,177 51,182 58,179 C64,176 66,165 65,151 C64,137 59,123 53,119 C48,116 43,118 42,120 Z" {...mp("triceps")}/>
      {/* TRICEPS right */}
      <path d="M158,120 C162,134 163,152 159,166 C156,177 149,182 142,179 C136,176 134,165 135,151 C136,137 141,123 147,119 C152,116 157,118 158,120 Z" {...mp("triceps")}/>
      <path d="M41,137 C49,139 57,139 66,137" {...WL}/>
      <path d="M41,155 C49,157 57,157 66,155" {...WL}/>
      <path d="M159,137 C151,139 143,139 134,137" {...WL}/>
      <path d="M159,155 C151,157 143,157 134,155" {...WL}/>
      {/* LATS left */}
      <path d="M49,96 C44,114 43,134 46,154 C49,172 56,184 64,190 C67,193 71,194 74,192 L75,181 C73,169 71,151 71,133 C71,115 73,98 75,87 C68,85 58,89 49,96 Z" {...mp("lats")}/>
      {/* LATS right */}
      <path d="M151,96 C156,114 157,134 154,154 C151,172 144,184 136,190 C133,193 129,194 126,192 L125,181 C127,169 129,151 129,133 C129,115 127,98 125,87 C132,85 142,89 151,96 Z" {...mp("lats")}/>
      <path d="M50,113 C57,120 64,124 74,126" {...WL}/>
      <path d="M49,134 C56,141 63,145 73,147" {...WL}/>
      <path d="M150,113 C143,120 136,124 126,126" {...WL}/>
      <path d="M151,134 C144,141 137,145 127,147" {...WL}/>
      {/* ERECTORS */}
      <rect x="94" y="108" width="6" height="76" rx="3" {...mp("back")}/>
      <rect x="100" y="108" width="6" height="76" rx="3" {...mp("back")}/>
      {/* GLUTES left */}
      <path d="M76,232 C71,248 71,265 77,278 C82,289 91,295 100,294 C109,293 114,284 113,272 C112,258 106,244 99,236 C94,228 82,228 76,232 Z" {...mp("glutes")}/>
      {/* GLUTES right */}
      <path d="M124,232 C129,248 129,265 123,278 C118,289 109,295 100,294 C91,293 86,284 87,272 C88,258 94,244 101,236 C106,228 118,228 124,232 Z" {...mp("glutes")}/>
      <path d="M100,232 L100,286" {...WL}/>
      <path d="M79,242 C87,238 94,237 100,241" {...WL}/>
      <path d="M121,242 C113,238 106,237 100,241" {...WL}/>
      {/* HAMSTRINGS left */}
      <path d="M75,262 C71,282 70,306 73,328 C75,345 80,358 87,364 L97,364 C101,357 103,342 103,321 C103,298 101,274 98,260 C95,249 87,246 80,248 Z" {...mp("hamstrings")}/>
      {/* HAMSTRINGS right */}
      <path d="M125,262 C129,282 130,306 127,328 C125,345 120,358 113,364 L103,364 C99,357 97,342 97,321 C97,298 99,274 102,260 C105,249 113,246 120,248 Z" {...mp("hamstrings")}/>
      <path d="M83,265 C83,290 83,315 82,347" {...WL}/>
      <path d="M91,263 C91,288 91,315 91,348" {...WL}/>
      <path d="M109,263 C109,288 109,315 109,348" {...WL}/>
      <path d="M117,265 C117,290 117,315 118,347" {...WL}/>
