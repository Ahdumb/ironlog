...
function MuscleHeatmap({ prs, allEx, bwLog, d }) {
  ...
  const G = "#e6e6e4";
  const outline = { stroke:"#ffffff", strokeWidth:3.2, strokeLinecap:"round", strokeLinejoin:"round" };
  ...
  const silhouette = (
    <>
      {/* HEAD */}
      <path d="M83,21 C83,8 117,8 117,21 L117,36 C120,38 121,44 118,48 C116,51 114,52 112,52 L112,61 C112,70 106,76 100,76 C94,76 88,70 88,61 L88,52 C86,52 84,51 82,48 C79,44 80,38 83,36 Z" {...bf}/>
      {/* TORSO + SHOULDERS (one continuous path, deltoid caps built in) */}
      <path d="M87,67 C76,78 62,82 48,88 C37,93 31,108 32,128 C33,145 42,151 52,148 C55,164 56,187 54,210 C53,232 49,252 47,270 C46,281 51,292 60,292 C68,292 71,281 71,269 C72,251 73,231 75,214 C78,191 84,164 84,140 L82,101 C89,108 95,111 100,111 C105,111 111,108 118,101 L116,140 C116,164 122,191 125,214 C127,231 128,251 129,269 C129,281 132,292 140,292 C149,292 154,281 153,270 C151,252 147,232 146,210 C144,187 145,164 148,148 C158,151 167,145 168,128 C169,108 163,93 152,88 C138,82 124,78 113,67 C109,78 104,84 100,84 C96,84 91,78 87,67 Z" {...bf}/>
      {/* LEFT ARM — upper arm + forearm + hand, one closed path overlapping shoulder */}
      <path d="M73,242 C64,268 62,302 68,336 C72,361 82,380 84,405 C86,425 79,435 67,442 C62,445 64,453 72,453 L89,453 C97,453 100,446 98,438 C96,415 99,390 102,365 C104,332 103,295 100,258 C89,258 80,253 73,242 Z" {...bf}/>
      {/* LEFT LEG — thigh + knee + calf + foot */}
      <path d="M127,242 C136,268 138,302 132,336 C128,361 118,380 116,405 C114,425 121,435 133,442 C138,445 136,453 128,453 L111,453 C103,453 100,446 102,438 C104,415 101,390 98,365 C96,332 97,295 100,258 C111,258 120,253 127,242 Z" {...bf}/>
      {/* RIGHT LEG */}
    </>
  );
  ...
  const frontSvg = (
    <svg viewBox="0 0 200 455" style={svgStyle}>
      ...
      <path d="M51,203 C47,221 45,242 47,262 C49,274 54,281 59,279 C60,256 62,232 67,210 Z" {...mp("biceps")}/>
      <path d="M67,207 C63,229 61,254 63,279 C68,275 72,263 73,247 C74,231 73,218 70,207 Z" {...mp("biceps")}/>
      <path d="M149,203 C153,221 155,242 153,262 C151,274 146,281 141,279 C140,256 138,232 133,210 Z" {...mp("biceps")}/>
      <path d="M133,207 C137,229 139,254 137,279 C132,275 128,263 127,247 C126,231 127,218 130,207 Z" {...mp("biceps")}/>
      {/* ABS 6-pack */}
      ...
      {/* QUADS left */}
      <path d="M75,258 C68,284 68,320 76,351 C80,365 86,372 91,369 C95,342 94,304 88,266 Z" {...mp("quads")}/>
      <path d="M91,267 C100,291 102,329 96,361 C91,352 88,328 88,304 C88,287 89,275 91,267 Z" {...mp("quads")}/>
      {/* QUADS right */}
      <path d="M125,258 C132,284 132,320 124,351 C120,365 114,372 109,369 C105,342 106,304 112,266 Z" {...mp("quads")}/>
      <path d="M109,267 C100,291 98,329 104,361 C109,352 112,328 112,304 C112,287 111,275 109,267 Z" {...mp("quads")}/>
      {/* CALVES left */}
      <path d="M78,377 C72,397 72,425 80,440 C84,447 91,446 94,437 C98,416 96,393 91,374 Z" {...mp("calves")}/>
      {/* CALVES right */}
      <path d="M122,377 C128,397 128,425 120,440 C116,447 109,446 106,437 C102,416 104,393 109,374 Z" {...mp("calves")}/>
    </svg>
  );
  ...
  const backSvg = (
    <svg viewBox="0 0 200 455" style={svgStyle}>
      {silhouette}
      {/* TRAPS */}
      <path d="M89,58 C84,74 78,89 66,99 C80,99 91,105 100,118 C109,105 120,99 134,99 C122,89 116,74 111,58 C107,72 103,84 100,94 C97,84 93,72 89,58 Z" {...mp("traps")}/>
      ...
      {/* LATS left */}
      <path d="M66,95 C55,111 50,135 55,160 C61,194 79,222 82,247 C98,214 101,166 96,119 C88,105 78,98 66,95 Z" {...mp("lats")}/>
      {/* LATS right */}
      <path d="M134,95 C145,111 150,135 145,160 C139,194 121,222 118,247 C102,214 99,166 104,119 C112,105 122,98 134,95 Z" {...mp("lats")}/>
      <path d="M62,122 C74,130 84,137 93,151" {...WL}/>
      <path d="M138,122 C126,130 116,137 107,151" {...WL}/>
      {/* ERECTORS */}
      ...
      {/* GLUTES left */}
      <path d="M75,239 C68,255 72,280 87,291 C96,297 101,292 100,274 C99,253 91,240 75,239 Z" {...mp("glutes")}/>
      <path d="M125,239 C132,255 128,280 113,291 C104,297 99,292 100,274 C101,253 109,240 125,239 Z" {...mp("glutes")}/>
      <path d="M100,236 L100,288" {...WL}/>
      <path d="M79,247 C87,241 94,240 100,245" {...WL}/>
      <path d="M121,247 C113,241 106,240 100,245" {...WL}/>
      {/* HAMSTRINGS left */}
      <path d="M76,269 C70,294 71,329 80,357 C84,370 90,374 95,367 C99,333 96,300 88,267 Z" {...mp("hamstrings")}/>
      <path d="M91,274 C100,300 101,334 96,365 C89,351 87,315 91,274 Z" {...mp("hamstrings")}/>
      {/* HAMSTRINGS right */}
      <path d="M124,269 C130,294 129,329 120,357 C116,370 110,374 105,367 C101,333 104,300 112,267 Z" {...mp("hamstrings")}/>
      <path d="M109,274 C100,300 99,334 104,365 C111,351 113,315 109,274 Z" {...mp("hamstrings")}/>
      {/* CALVES back */}
      <path d="M78,377 C72,397 72,425 80,440 C84,447 91,446 94,437 C98,416 96,393 91,374 Z" {...mp("calves")}/>
      <path d="M122,377 C128,397 128,425 120,440 C116,447 109,446 106,437 C102,416 104,393 109,374 Z" {...mp("calves")}/>
    </svg>
