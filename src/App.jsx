...
function MuscleHeatmap({ prs, allEx, bwLog, d }) {
  ...
  const WL = { fill:"none", stroke:"rgba(255,255,255,0.78)", strokeWidth:1.1, strokeLinecap:"round", pointerEvents:"none" };

  // Natural standing pose. ViewBox 200×470. Center x=100.
  const silhouette = (
    <>
      {/* HEAD */}
      <ellipse cx="100" cy="26" rx="18" ry="21" {...bf}/>
      {/* NECK */}
      <path d="M94,47 L93,62 L107,62 L106,47 Z" {...bf}/>
      {/* TORSO */}
      <path d="M70,62 C59,66 52,78 51,93 C50,109 52,127 55,145 C58,161 63,174 69,185 C75,196 83,205 91,211 L100,215 L109,211 C117,205 125,196 131,185 C137,174 142,161 145,145 C148,127 150,109 149,93 C148,78 141,66 130,62 Z" {...bf}/>
      {/* HIPS */}
      <path d="M91,211 C87,219 85,229 85,239 L100,243 L115,239 C115,229 113,219 109,211 Z" {...bf}/>
      {/* LEFT SHOULDER CAP */}
      <path d="M64,65 C55,69 49,79 47,90 C45,101 47,112 54,118 C61,124 70,121 76,114 C82,107 83,97 80,87 C77,77 70,69 64,65 Z" {...bf}/>
      {/* RIGHT SHOULDER CAP */}
      <path d="M136,65 C145,69 151,79 153,90 C155,101 153,112 146,118 C139,124 130,121 124,114 C118,107 117,97 120,87 C123,77 130,69 136,65 Z" {...bf}/>
      {/* LEFT UPPER ARM — hangs at side */}
      <path d="M48,88 C43,102 41,118 41,134 C41,150 43,164 47,175 C50,183 56,187 62,185 C68,183 72,175 74,160 C76,145 75,129 72,113 C69,98 64,87 58,84 C53,82 50,86 48,88 Z" {...bf}/>
      {/* RIGHT UPPER ARM */}
      <path d="M152,88 C157,102 159,118 159,134 C159,150 157,164 153,175 C150,183 144,187 138,185 C132,183 128,175 126,160 C124,145 125,129 128,113 C131,98 136,87 142,84 C147,82 150,86 152,88 Z" {...bf}/>
      {/* LEFT FOREARM */}
      <path d="M47,175 C43,187 41,202 41,217 C41,229 43,239 48,244 C52,249 59,247 64,239 C69,229 72,213 72,197 C70,188 63,183 55,184 Z" {...bf}/>
      {/* RIGHT FOREARM */}
      <path d="M153,175 C157,187 159,202 159,217 C159,229 157,239 152,244 C148,249 141,247 136,239 C131,229 128,213 128,197 C130,188 137,183 145,184 Z" {...bf}/>
      {/* LEFT HAND */}
      <path d="M42,243 C40,251 40,261 42,268 C43,272 46,274 49,272 L50,268 L52,275 L55,275 L56,269 L58,275 L61,275 L61,268 L63,272 L65,270 L64,261 C65,254 65,245 61,240 C57,235 48,235 44,238 Z" {...bf}/>
      {/* RIGHT HAND */}
      <path d="M158,243 C160,251 160,261 158,268 C157,272 154,274 151,272 L150,268 L148,275 L145,275 L144,269 L142,275 L139,275 L139,268 L137,272 L135,270 L136,261 C135,254 135,245 139,240 C143,235 152,235 156,238 Z" {...bf}/>
      {/* LEFT THIGH */}
      <path d="M86,241 C83,259 82,280 84,300 C86,316 90,328 96,334 L105,334 C109,328 111,314 111,294 C112,272 110,252 106,238 C103,228 96,225 89,227 Z" {...bf}/>
      {/* RIGHT THIGH */}
      <path d="M114,241 C117,259 118,280 116,300 C114,316 110,328 104,334 L95,334 C91,328 89,314 89,294 C88,272 90,252 94,238 C97,228 104,225 111,227 Z" {...bf}/>
      {/* LEFT KNEE */}
      <ellipse cx="96" cy="340" rx="12" ry="7" {...bf}/>
      {/* RIGHT KNEE */}
      <ellipse cx="104" cy="340" rx="12" ry="7" {...bf}/>
      {/* LEFT CALF */}
      <path d="M84,347 C80,364 80,383 83,400 C86,413 91,422 97,424 L103,424 C107,420 110,410 111,396 C112,378 110,360 107,347 Z" {...bf}/>
      {/* RIGHT CALF */}
      <path d="M116,347 C120,364 120,383 117,400 C114,413 109,422 103,424 L97,424 C93,420 90,410 89,396 C88,378 90,360 93,347 Z" {...bf}/>
      {/* LEFT FOOT */}
      <path d="M84,424 L82,436 C74,439 66,442 64,446 L100,446 L100,424 Z" {...bf}/>
      {/* RIGHT FOOT */}
      <path d="M116,424 L118,436 C126,439 134,442 136,446 L100,446 L100,424 Z" {...bf}/>
    </>
  );

  const svgStyle = { width:"100%", maxWidth:150, display:"block" };

  const frontSvg = (
    <svg viewBox="0 0 200 460" style={svgStyle}>
      {silhouette}
      {/* CHEST left pec */}
      <path d="M100,76 C86,72 70,73 62,82 C57,88 57,100 61,108 C65,116 74,120 84,120 C94,120 100,115 100,107 Z" {...mp("chest")}/>
      {/* CHEST right pec */}
      <path d="M100,76 C114,72 130,73 138,82 C143,88 143,100 139,108 C135,116 126,120 116,120 C106,120 100,115 100,107 Z" {...mp("chest")}/>
      {/* chest sternum + upper/lower division */}
      <path d="M100,77 L100,112" {...WL}/>
      <path d="M64,100 C76,104 88,106 100,106 C112,106 124,104 136,100" {...WL}/>
      {/* SHOULDERS left anterior delt */}
      <path d="M47,89 C42,98 41,110 44,120 C47,128 55,132 63,129 C71,126 74,116 72,105 C70,94 62,87 54,88 Z" {...mp("shoulders")}/>
      {/* SHOULDERS right */}
      <path d="M153,89 C158,98 159,110 156,120 C153,128 145,132 137,129 C129,126 126,116 128,105 C130,94 138,87 146,88 Z" {...mp("shoulders")}/>
      {/* shoulder division arc */}
      <path d="M46,104 C53,108 62,110 73,107" {...WL}/>
      <path d="M154,104 C147,108 138,110 127,107" {...WL}/>
      {/* BICEPS left */}
      <path d="M42,97 C38,110 37,127 41,140 C44,150 50,154 57,152 C63,149 65,139 64,126 C63,113 59,101 53,96 C48,93 43,95 42,97 Z" {...mp("biceps")}/>
      {/* BICEPS right */}
      <path d="M158,97 C162,110 163,127 159,140 C156,150 150,154 143,152 C137,149 135,139 136,126 C137,113 141,101 147,96 C152,93 157,95 158,97 Z" {...mp("biceps")}/>
      {/* biceps head line */}
      <path d="M41,122 C48,124 55,124 65,122" {...WL}/>
      <path d="M159,122 C152,124 145,124 135,122" {...WL}/>
      {/* FOREARM muscles left */}
      <path d="M42,185 C40,196 40,208 43,218 C45,225 50,228 55,226 C60,223 63,213 63,200 C61,192 55,188 48,189 Z" {...mp("abs")} onClick={undefined} cursor="default" fill={G}/>
      {/* ABS 6-pack */}
      <rect x="88" y="124" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="102" y="124" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="87" y="140" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="103" y="140" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="88" y="156" width="10" height="12" rx="3" {...mp("abs")}/>
      <rect x="102" y="156" width="10" height="12" rx="3" {...mp("abs")}/>
      {/* Obliques */}
      <path d="M55,118 C53,131 52,146 54,158 C56,168 60,174 66,175 L69,162 C67,152 66,140 66,129 C67,119 68,110 71,103 C64,103 58,108 55,118 Z" {...mp("abs")}/>
      <path d="M145,118 C147,131 148,146 146,158 C144,168 140,174 134,175 L131,162 C133,152 134,140 134,129 C133,119 132,110 129,103 C136,103 142,108 145,118 Z" {...mp("abs")}/>
      {/* QUADS left */}
      <path d="M86,241 C83,259 82,280 84,300 C86,316 90,328 96,334 L105,334 C109,328 111,314 111,294 C112,272 110,252 106,238 C103,228 96,225 89,227 Z" {...mp("quads")}/>
      {/* QUADS right */}
      <path d="M114,241 C117,259 118,280 116,300 C114,316 110,328 104,334 L95,334 C91,328 89,314 89,294 C88,272 90,252 94,238 C97,228 104,225 111,227 Z" {...mp("quads")}/>
      {/* quad head dividers */}
      <path d="M94,244 C93,266 93,290 92,322" {...WL}/>
      <path d="M100,243 C100,265 100,290 100,325" {...WL}/>
      <path d="M106,244 C107,266 107,290 108,322" {...WL}/>
      {/* CALVES left */}
      <path d="M84,347 C80,364 80,383 83,400 C86,413 91,422 97,424 L103,424 C107,420 110,410 111,396 C112,378 110,360 107,347 Z" {...mp("calves")}/>
      {/* CALVES right */}
      <path d="M116,347 C120,364 120,383 117,400 C114,413 109,422 103,424 L97,424 C93,420 90,410 89,396 C88,378 90,360 93,347 Z" {...mp("calves")}/>
      {/* calf medial/lateral divider */}
      <path d="M97,349 C97,372 97,396 97,420" {...WL}/>
      <path d="M103,349 C103,372 103,396 103,420" {...WL}/>
    </svg>
  );
  ...
  const backSvg = (
    <svg viewBox="0 0 200 460" style={svgStyle}>
      {silhouette}
      {/* TRAPS */}
      <path d="M93,49 C81,55 69,65 66,76 C64,84 66,93 74,98 C83,103 92,104 100,103 C108,104 117,103 126,98 C134,93 136,84 134,76 C131,65 119,55 107,49 Z" {...mp("traps")}/>
      <path d="M100,50 L100,101" {...WL}/>
      <path d="M79,67 C87,71 94,73 100,73 C106,73 113,71 121,67" {...WL}/>
      {/* REAR DELTS left */}
      <path d="M47,89 C42,98 41,110 44,120 C47,128 55,132 63,129 C71,126 74,116 72,105 C70,94 62,87 54,88 Z" {...mp("reardelts")}/>
      {/* REAR DELTS right */}
      <path d="M153,89 C158,98 159,110 156,120 C153,128 145,132 137,129 C129,126 126,116 128,105 C130,94 138,87 146,88 Z" {...mp("reardelts")}/>
      {/* TRICEPS left — 3 heads */}
      <path d="M42,97 C38,110 37,127 41,140 C44,150 50,154 57,152 C63,149 65,139 64,126 C63,113 59,101 53,96 C48,93 43,95 42,97 Z" {...mp("triceps")}/>
      {/* TRICEPS right */}
      <path d="M158,97 C162,110 163,127 159,140 C156,150 150,154 143,152 C137,149 135,139 136,126 C137,113 141,101 147,96 C152,93 157,95 158,97 Z" {...mp("triceps")}/>
      {/* triceps head lines */}
      <path d="M41,115 C48,117 56,117 65,115" {...WL}/>
      <path d="M41,133 C48,135 56,135 65,133" {...WL}/>
      <path d="M159,115 C152,117 144,117 135,115" {...WL}/>
      <path d="M159,133 C152,135 144,135 135,133" {...WL}/>
      {/* LATS left — V shape from under rear delt to lower back */}
      <path d="M50,87 C46,103 45,121 47,140 C49,156 54,168 61,174 C64,177 67,178 70,176 L71,166 C69,155 68,138 68,122 C68,106 69,90 71,80 C64,78 56,81 50,87 Z" {...mp("lats")}/>
      {/* LATS right */}
      <path d="M150,87 C154,103 155,121 153,140 C151,156 146,168 139,174 C136,177 133,178 130,176 L129,166 C131,155 132,138 132,122 C132,106 131,90 129,80 C136,78 144,81 150,87 Z" {...mp("lats")}/>
      {/* lat fiber lines */}
      <path d="M51,102 C56,108 62,112 71,114" {...WL}/>
      <path d="M50,122 C55,128 62,132 70,134" {...WL}/>
      <path d="M149,102 C144,108 138,112 129,114" {...WL}/>
      <path d="M150,122 C145,128 138,132 130,134" {...WL}/>
      {/* ERECTORS */}
      <rect x="94" y="100" width="7" height="76" rx="3" {...mp("back")}/>
      <rect x="99" y="100" width="7" height="76" rx="3" {...mp("back")}/>
      {/* GLUTES left */}
      <path d="M85,218 C81,232 81,247 86,259 C91,269 98,275 106,274 C114,273 118,265 118,253 C118,240 113,226 107,218 C102,211 92,210 85,214 Z" {...mp("glutes")}/>
      {/* GLUTES right */}
      <path d="M115,218 C119,232 119,247 114,259 C109,269 102,275 94,274 C86,273 82,265 82,253 C82,240 87,226 93,218 C98,211 108,210 115,214 Z" {...mp("glutes")}/>
      {/* glute division line */}
      <path d="M100,218 L100,268" {...WL}/>
      <path d="M87,228 C93,224 100,223 107,228" {...WL}/>
      {/* HAMSTRINGS left */}
      <path d="M86,241 C83,259 82,280 84,300 C86,316 90,328 96,334 L105,334 C109,328 111,314 111,294 C112,272 110,252 106,238 C103,228 96,225 89,227 Z" {...mp("hamstrings")}/>
      {/* HAMSTRINGS right */}
      <path d="M114,241 C117,259 118,280 116,300 C114,316 110,328 104,334 L95,334 C91,328 89,314 89,294 C88,272 90,252 94,238 C97,228 104,225 111,227 Z" {...mp("hamstrings")}/>
      {/* ham medial/lateral division */}
      <path d="M94,245 C93,268 93,292 92,322" {...WL}/>
      <path d="M100,243 C100,266 100,292 100,325" {...WL}/>
      <path d="M106,245 C107,268 107,292 108,322" {...WL}/>
      {/* CALVES back */}
      <path d="M84,347 C80,364 80,383 83,400 C86,413 91,422 97,424 L103,424 C107,420 110,410 111,396 C112,378 110,360 107,347 Z" {...mp("calves")}/>
      <path d="M116,347 C120,364 120,383 117,400 C114,413 109,422 103,424 L97,424 C93,420 90,410 89,396 C88,378 90,360 93,347 Z" {...mp("calves")}/>
      <path d="M97,349 C97,372 97,396 97,420" {...WL}/>
